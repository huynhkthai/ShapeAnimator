...
/**
 * This is the Junit test class for the Model.Oval shape class.
 */
public class OvalTest {
  ...
  @Before
  public void setUp() {
    tester = new Oval("Tester", ShapeName.Ellipse, 0, 0, 10,
            50, 0, 100, 100, 200, 200);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructorInvalidShapeType() {
    Shape test = new Oval("Test", ShapeName.Circle, 2, 3, 3,
            10, 23, 44, 150, 23, 167);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNegWidth() {
    Shape test = new Oval("Test", ShapeName.Ellipse, 3, 4, -10,
            20, 1, 10, 100, 30, 150);
  }
  ...
  public void testNegHeight() {
    Shape test = new Oval("Test", ShapeName.Ellipse, 3, 4, 10,
            -20, 10, 100, 100, 30, 150);
  }

  //Test RGB value too large
  @Test(expected = IllegalArgumentException.class)
  public void testConstructorInvalidColor() {
    Shape test = new Oval("Test", ShapeName.Ellipse, 5, -12, 50,
            23, 1, 55, 300, 23, 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructorInvalidColorNeg() {
    Shape test = new Oval("Test", ShapeName.Ellipse, 2, 34, 29,
            89, 1, 100, -23, 24, 200);
  }
  ...
  public void testColorChange() {
    Shape test = new Oval("Test", ShapeName.Ellipse, 0, 1, 10,
            20, 0, 100, 200, 100, 150);
    ...
    assertEquals("Name: Test\n"
            + "Type: Ellipse\n"
            + "Center: (0,1), Width: 20, Height: 40, Color : (24,56,100\n"
            + "Appears at t=0\n"
            + "Disappears at t=100\n", test.toString());
  }
